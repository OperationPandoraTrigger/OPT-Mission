...
["LandVehicle", "init", {
    ...
    if (typeOf _vec  == "OPT_O_T_Truck_03_repair_ghex_F" || typeOf _vec == "OPT_O_Truck_03_repair_F" || typeOf _vec  == "OPT_B_Truck_01_Repair_F" || typeOf _vec  == "OPT_B_Truck_01_Repair_ghex_F") then {
