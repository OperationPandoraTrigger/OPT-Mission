...
["CAManBase", "init", {
    ...
    */
	...
	_action_first_aid_medic = [
        "OPT_REVIVE_REVIVE",
        FAR_REVIVE_ACTION_FIRST_AID_MEDIC,
        "",
        {
            params ["_target", "_player", "_params"]; 

            [_target, _player, "action_first_aid_medic"] call FUNC(handleAction);
        },
        {
            params ["_target", "_player", "_params"];
    ...
    */
    ...
    } forEach [_action_first_aid_medic, _action_revive, _action_stabilize, _action_drag];
