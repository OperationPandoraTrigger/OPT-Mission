/**
* Author: form
* Fills MyPosition-Editbox with actual player position and a string of a landmark nearby
* as an example in a format which you can paste into the Beampunkt-Verwaltung.
*
* Arguments:
* None
*
...
if (_dialog isEqualTo displayNull) exitWith {ERROR_MSG("Fehler beim Aufruf von fnc_initMyPosDialog!")};
...
private _location = "";
{
	if (text _x != "") exitWith {_location = text _x};
...
// write position and location-name to edit-ctrl
