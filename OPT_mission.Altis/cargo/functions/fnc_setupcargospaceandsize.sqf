...
// NATO Helicopters	
	...
	["OPT_B_Heli_Transport_02_F", 10],			    	// CH-49 Mohawk (Transport+Lift)    von 30
	["OPT_B_Heli_Transport_03_unarmed_F", 10],	       	// CH-67 Huron unarmed (Transport+Lift)     von 30
	["OPT_B_Heli_Transport_03_F", 10],			    	// CH-67 Huron armed (Transport+Lift)       von 30
	["OPT_B_T_VTOL_01_infantry_F", 10],			    	// Blackfish (Inf-Transport) - grad nicht drin!
	["OPT_B_T_VTOL_01_vehicle_F", 10],			    	// Blackfish (Vehikel-Transport)	
	["OPT_B_T_VTOL_02_infantry_unarmed_F", 10],			    	// Xian (Inf-Transport)   - hinzugefügt
// NATO ships
...
// CSAT Armored
    ...
    ["OPT_O_Truck_02_MRL_F", 1],                 		// 2S9 Sochor   
...
//vanilla	
	...
	["OPT4_O_MBT_02_cannon_F", 4],				        // T-100  - neu
// CSAT Helicopter
...
[	
// NATO Vehicles
    ["OPT_B_Quadbike_01_F", 4],						    // Quadbike	- checken!
	["OPT_B_G_Offroad_01_F", 6],					    // Pickup - grad nich drin!
	["OPT_B_G_Offroad_01_armed_F", 6],				    // Pickup HMG - grad nich drin!
	["OPT_B_T_LSV_01_unarmed_F", 6], 				    // Prowler unarmed
	["OPT_B_T_LSV_01_armed_F", 6],                      // Prowler armed
	["B_T_LSV_01_AT_F", 6], 						// Prowler AT - vanilla - lord
	["OPT_B_MRAP_03_F", 6],							    // Strider - grad nich drin!
	["OPT_B_MRAP_03_hmg_F", 6],						    // Strider HMG - grad nich drin!
	["OPT4_B_MRAP_03_gmg_F", 6],						    // Strider GMG
	["OPT_B_MRAP_01_F", 6],							    // Hunter
	["OPT4_B_MRAP_01_hmg_F", 6],						    // Hunter HMG
	["OPT4_B_MRAP_01_gmg_F", 6],						    // Hunter GMG
	["OPT_B_Truck_01_covered_F", 10], 					// HEMTT Inf-Transport
	["OPT_B_Truck_01_transport_F", 10],				    // HEMTT Logistik - hinzugefügt
	["OPT_B_Truck_01_ammo_F", 10],                 // HEMTT Ammo, 50000 ersetzt durch Container
    ["OPT_B_Truck_01_fuel_F", 10],
	["OPT_B_Truck_01_Repair_F", 10],               // HEMTT Repair, ersetzt durch Container
    ["OPT_B_Truck_01_medical_F", 10],              // HEMTT Medical, ersetzt durch Container
// NATO Armored	
	["OPT_B_APC_Wheeled_01_cannon_F", 10],			    // AMV-7 Marshall
	["OPT4_B_APC_Wheeled_01_cannon_F", 10],				// AMV-7 Marshall - neu
	["OPT_B_APC_Wheeled_01_cannon_light_F", 10],		    // AMV-7 Marshall (Leicht)
	["OPT_B_MBT_01_cannon_F", 10],					    // M2A4 Slammer
	["OPT4_B_MBT_01_cannon_F", 10],					    // M2A4 Slammer - neu
	["OPT_B_MBT_01_TUSK_F", 10],						    // M2A4 SlammerUp
	["OPT4_B_MBT_01_TUSK_F", 10],				    // M2A4 SlammerUp - neu
	["OPT_B_APC_Tracked_01_rcws_F", 10],				    // IFV-6c Panther	von 30
	["OPT4_B_APC_Tracked_01_rcws_F", 10],		    // IFV-6c Panther - neu
	["OPT_B_APC_tracked_03_cannon_F", 10],		        // FV-720 Mora	 von 30
	["OPT4_B_APC_tracked_03_cannon_F", 10],		// FV-720 Mora - neu
	["OPT4_B_LSV_01_AT_F", 10],                     // Prowler AT 
...
// CSAT Vehicles	
	["OPT_O_T_Quadbike_01_ghex_F", 4],				    // Quadbike	- checken!
	["OPT_O_T_LSV_02_unarmed_F", 6], 				    // Quilin unarmed
	["OPT_O_T_LSV_02_armed_F", 6],					    // Quilin armed
	["O_T_LSV_01_AT_F_un", 6], 						// Prowler AT - vanilla	- lord
    ["OPT_O_G_Offroad_01_F", 6],					    // Pickup  - grad nich drin!
    ["OPT_O_G_Offroad_01_armed_F", 6],				    // Pickup HMG  - grad nich drin!
	["OPT_O_T_MRAP_02_ghex_F", 6],					    // Ifrit - tropentarn hinzugefügt
	["OPT_O_T_MRAP_02_hmg_ghex_F", 6],				    // Ifrit HMG  - tropentarn hinzugefügt
	["OPT_O_T_MRAP_02_gmg_ghex_F", 6],				    // Ifrit GMG  - tropentarn hinzugefügt
	["OPT_O_T_Truck_03_covered_ghex_F", 10],			    // Tempest Transport	
	["OPT_O_T_Truck_03_transport_ghex_F", 10],		    // Tempest Logistik - hinzugefügt
	["OPT_O_T_Truck_03_ammo_ghex_F", 10],              // Tempest Ammo, ersetzt durch container 50000
    ["OPT_O_T_Truck_03_fuel_ghex_F", 10],              // Tempest Fuel, ersetzt durch container 10000
    ["OPT_O_Truck_03_ammo_F", 10],                 // Tempest Ammo, ersetzt durch container
    ["OPT_O_Truck_03_fuel_F", 10],                  // Tempest Fuel, ersetzt durch container
	["OPT_O_Truck_03_repair_F", 10],               // Tempest Repair, ersetzt durch container-
    ["OPT_O_Truck_03_medical_F", 10],              // Tempest Medical, ersetzt durch container-
//vanilla	
	["OPT_O_Quadbike_01_F", 4],					        // Quadbike	- checken!
	["OPT_O_MRAP_02_F", 6],						        // Ifrit - tropentarn hinzugefügt
	["OPT_O_MRAP_02_hmg_F", 6],					        // Ifrit HMG  - tropentarn hinzugefügt
	["OPT_O_MRAP_02_gmg_F", 6],					        // Ifrit GMG  - tropentarn hinzugefügt
	["OPT4_O_MRAP_02_hmg_F", 6],				// Ifrit HMG - neu
	["OPT4_O_MRAP_02_gmg_F", 6],					// Ifrit GMG - neu
	["OPT_O_Truck_03_covered_F", 10],			        // Tempest Transport	
	["OPT_O_Truck_03_transport_F", 10],			        // Tempest Logistik - hinzugefügt
// CSAT Armored
	["OPT_O_APC_Wheeled_03_cannon_F", 10],			    // AFV-4 Gorgon
	["OPT_O_APC_Wheeled_03_cannon_light_F", 10],		    // AFV-4 Gorgon (Leicht)
	["OPT4_O_APC_Wheeled_03_cannon_F", 10],			    // AFV-4 Gorgon - neu
	["OPT_O_T_APC_Wheeled_02_rcws_ghex_F", 10],			// MSE-3 Marid  - tropentarn hinzugefügt
	["OPT_O_T_APC_Tracked_02_cannon_ghex_F", 10],		// BTR-K Kamysh (Titan)
	["OPT_O_T_APC_Tracked_02_cannon_ghex_light_F", 10],	// BTR-K Kamysh	
	["OPT4_O_APC_Tracked_02_cannon_F", 10],	// BTR-K Kamysh	- neu
	["OPT4_O_APC_Tracked_02_AA_F", 10],           // ZSU-39 Tigris
	["OPT_O_T_MBT_02_cannon_ghex_F", 10],				// T-100  - hinzugefügt
	["OPT4_O_MBT_02_arty_F", 10],                 		// 2S9 Sochor
    ["OPT_O_Truck_02_MRL_F", 10],                 		// 2S9 Sochor   
	["OPT4_O_T_MBT_02_arty_ghex_F", 10],      		 // 2S9 Sochor
	["OPT4_O_LSV_02_AT_F", 10],                    // Quilin AT
//vanilla	
	["OPT4_O_APC_Wheeled_02_rcws_F", 10],			        // MSE-3 Marid  - neu
	["OPT_O_APC_Tracked_02_cannon_F", 10],		        // BTR-K Kamysh (Titan)
	["OPT_O_APC_Tracked_02_cannon_light_F", 10],	        // BTR-K Kamysh	
	["OPT_O_MBT_02_cannon_F", 10],				        // T-100  - hinzugefügt
	["OPT4_O_MBT_02_cannon_F", 10],						// T-100  - hinzugefügt
// CSAT supplies
