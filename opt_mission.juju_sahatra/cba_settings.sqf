...
force ace_common_checkPBOsWhitelist = "['CLib', 'Streamator', 'opt', 'Insight', 'OCAP', 'a3uf_common', 'a3uf_json']";
...
// ACE Cook off
force force ace_cookoff_ammoCookoffDuration = 0.178253;
force force ace_cookoff_enable = 0;
force force ace_cookoff_enableAmmobox = false;
force force ace_cookoff_enableAmmoCookoff = true;
force force ace_cookoff_probabilityCoef = 0.215387;
...
force ace_magazinerepack_timePerBeltLink = 5.99999;
...
force ace_viewdistance_limitViewDistance = 5895.67;
ace_viewdistance_objectViewDistanceCoeff = 0;
ace_viewdistance_viewDistanceAirVehicle = 10;
ace_viewdistance_viewDistanceLandVehicle = 10;
ace_viewdistance_viewDistanceOnFoot = 10;
...
force force opt_SECTORCONTROL_nato_allsectors_str = "2";
force force opt_SECTORCONTROL_nato_sectors_str = "2";
force force opt_SECTORCONTROL_csat_faction = "SWORD";
force force opt_SECTORCONTROL_csat_allsectors_str = "1";
force force opt_SECTORCONTROL_csat_sectors_str = "1";
...
TFAR_VolumeHudTransparency = 0.518419;
...
force force TFAR_globalRadioRangeCoef = 1.5;
...
force force TFAR_setting_defaultFrequencies_lr_west = "40,41,42,30,31,32,51,52,50";
force force TFAR_setting_defaultFrequencies_lr_east = "60,61,62,70,71,72,80,81,82";
force force TFAR_setting_defaultFrequencies_sr_west = "40,41,42,30,31,32,51,52";
...
force force TFAR_Teamspeak_Channel_Name = "2302";
force force TFAR_Teamspeak_Channel_Password = "war";
